const messages = {
	en: {
		...
		indexUser: {
			...
			msg11: 'Please upload a photo of hand-held front page of passport and handwritten note;',
			msg12: 'The note should contain "LittleBeeX" and the current date;',
			msg13: 'Please make sure that the front page of passport and handwritten note are clearly visible.',
	...
	cn: {
		...
		indexUser: {
			...
			msg9: '护照上传',
			msg10: '查看图片',
			msg11: '请上传一张手持护照人像面和个人签字的照片；',
			msg12: '个人签字的内容包含”LittleBeeX“和当前日期；',
			msg13: '请确保照片和个人签字内容清晰可见。',
